...
```mermaid
graph TD
    S1["1. Hero Section<br/><i>New Headline, Subhead & Professional Cutout</i>"]
    S2["2. Value Pillars<br/><i>4-Dot Brand Motif + 4 Benefit Cards</i>"]
    S3["3. Important Choice #1<br/><i>Choosing Your Certification + Interactive Matcher</i>"]
    S4["4. Important Choice #2<br/><i>Choosing How to Prepare + 3-Tier Comparison Matrix</i>"]
    S5["5. Video Explainer<br/><i>Pros & Cons Landscape Video Embed</i>"]
    S6["6. Social Proof & Graduates<br/><i>Real photos holding HRCI certificates</i>"]
    S7["7. Best Practices / Roadmap<br/><i>7-Step Certification Best Practices replacing legacy 6-box grid</i>"]
    S8["8. Resource Center & Contact<br/><i>Webcasts, Demo, Booking & Reassurance</i>"]
